...
exports.UserMatchOdds = function (req, res, next) {
    ...
    exports.UserMatchOddstest =function(id,callback){
        ...
        async.series([
            ...
            function (do_callback) {
                ...
                let query2 = `SELECT id session_id, event_id, RunnerName, LayPrice1, LaySize1, BackPrice1, BackSize1, GameStatus, SelectionId
                    FROM match_sessions 
                    WHERE event_id=${id} AND is_allowed=1 AND is_result=0 AND is_abandoned=0`;
            ...
            function (do_callback) {
                ...
                // get score
                let query1 = `SELECT * FROM match_scores WHERE event_id=${id}`;
